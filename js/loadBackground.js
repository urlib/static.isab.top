...
(() => {
    ...
    const backgroundImageList = [
        {
            name: 'Galaxy',
            png: 'gh/urlib/bin_0@f5a296f9/fe/94/83/5f/fe94835f3f8985e5965b9fe974d1917858affba03182c2aef5071ffbfcaee61c.png',
            webp: 'gh/urlib/bin_0@f5a296f9/95/11/c2/d9/9511c2d95bdce8999a519c9f7c1910b316c4c6728bf6b7ef7ee9cdfd1a0faeb1.webp'
        },
        {
            name: 'Purple Galaxy',
            png: 'gh/urlib/bin_0@f5a296f9/db/2e/1e/54/db2e1e54c1152b4dfef159d9668427876d7f5cd0a1a8e8caa83afa83cb4914de.png',
    ...
    const imageChoice = (isWebpSupported) => {
        ...
        return completeUrl(isWebpSupported ? image.webp : image.png);
    };
